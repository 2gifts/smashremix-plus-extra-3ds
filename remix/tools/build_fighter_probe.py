...
def main():
    ...
    art((256, 128), 'REMIX FIGHTER TEST\nFalco / DK Ult / J DK\nJ Pika / E Pika / E Samus\nJ Mario / J Falcon / J Luigi\nFull mod in development', 13, dst / 'banner.png')
    ...
    run(tool('bannertool'), 'makesmdh', '-s', 'Remix fighter test', '-l',
        'Eleven fighter integrations via VS bottom screen - full port unfinished', '-p', 'Remix / decomp / port contributors',
    ...
    report = {'development_only': True, 'build_variant': 'fighter-test', 'fully_playable': False,
              'scope': 'Falco, DK Ult, J DK, J Pikachu, E Pikachu, E Samus, J Mario, J Falcon and J Luigi selectable from their parent VS bottom cards; full Remix roster and menus unfinished',
