...
def main():
    ...
    run(tool('bannertool'), 'makesmdh', '-s', 'Remix fighter test', '-l',
        'Twelve fighter integrations via VS bottom screen - full port unfinished', '-p', 'Remix / decomp / port contributors',
    ...
    report = {'development_only': True, 'build_variant': 'fighter-test', 'fully_playable': False,
              'scope': 'Twelve imported fighters selectable from their parent VS bottom cards; full Remix roster and menus unfinished',
