...
def main():
    ...
    run(tool('bannertool'), 'makesmdh', '-s', 'Remix fighter test', '-l',
        'Six fighter integrations via VS bottom screen - full port unfinished', '-p', 'Remix / decomp / port contributors',
    ...
    report = {'development_only': True, 'build_variant': 'fighter-test', 'fully_playable': False,
              'scope': 'Falco, DK Ult, J Pikachu, J Mario, J Falcon and J Luigi selectable from their parent VS bottom cards; full Remix roster and menus unfinished',
