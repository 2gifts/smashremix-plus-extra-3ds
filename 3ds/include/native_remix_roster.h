...
#define NATIVE_REMIX_DRL_KIND 75u
#define NATIVE_REMIX_MLUIGI_KIND 69u
...
static const NativeRemixVariant native_remix_variants[] = {
    ...
    {NATIVE_REMIX_DRL_KIND, NATIVE_REMIX_LUIGI_KIND},
    {NATIVE_REMIX_MLUIGI_KIND, NATIVE_REMIX_LUIGI_KIND},
...
static inline unsigned nativeRemixParentKind(unsigned fkind) {
    ...
    case NATIVE_REMIX_DRL_KIND: return NATIVE_REMIX_LUIGI_KIND;
    case NATIVE_REMIX_MLUIGI_KIND: return NATIVE_REMIX_LUIGI_KIND;
