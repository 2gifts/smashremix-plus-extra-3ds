...
static unsigned fighterArt(unsigned c){return c==29?1:c==81?2:c==44?2:c==50?9:c==45?9:c==42?0:c==40?7:c==43?4:c==13?0:c==26?2:c>=14&&c<26?c-14:c;}
static const char* fighterName(unsigned c){return c==29?"FALCO":c==81?"DK ULT":c==44?"J DK":c==50?"J PIKA":c==45?"E PIKA":c==42?"J MARIO":c==40?"J FALCON":c==43?"J LUIGI":c==12?"MASTER HAND":c==13?"METAL MARIO":c==26?"GIANT DK":c>=14&&c<26?"POLYGON":c<12?names[c]:"SELECT";}
