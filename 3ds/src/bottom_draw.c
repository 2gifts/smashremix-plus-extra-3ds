...
static const char* fighterName(unsigned c){return c==29?"FALCO":c==81?"DK ULT":c==44?"J DK":c==50?"J PIKA":c==45?"E PIKA":c==51?"E SAMUS":c==35?"E LINK":c==39?"J LINK":c==49?"J YOSHI":c==42?"J MARIO":c==40?"J FALCON":c==43?"J LUIGI":c==37?"J NESS":c==12?"MASTER HAND":c==13?"METAL MARIO":c==26?"GIANT DK":c>=14&&c<26?"POLYGON":c<12?names[c]:"SELECT";}
