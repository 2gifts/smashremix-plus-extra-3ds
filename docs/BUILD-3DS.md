...
To test on a homebrewed **New Nintendo 3DS / New 3DS XL**, copy this local CIA to the SD card and install it with FBI. Launch **Remix fighter test**, enter VS mode, select **Fox**, **Pikachu**, **Mario**, **Captain Falcon**, **Luigi**, or **Donkey Kong** on the top screen, then tap that player's bottom-screen card. Fox, Pikachu, Mario, Captain Falcon, and Luigi toggle to **Falco**, **J Pikachu**, **J Mario**, **J Falcon**, and **J Luigi**. The Donkey Kong card cycles through **DK Ult**, **J DK**, and ordinary Donkey Kong with successive taps. The bottom card names the imported fighter, while the original top-screen portrait and announcer still use the vanilla parent. Training and other modes do not have this selector. The existing 3D slider, display toggle and control options are available.
